...
eUICC SIMs are single SIMs that can host multiple network operator profiles, which are installed and managed remotely.

![](../../.gitbook/assets/eSIM_RSP-A.png)
...
![](../../.gitbook/assets/eSIM_RSP-B.png)

![](../../.gitbook/assets/eSIM_RSP-C.png)
...
![](../../.gitbook/assets/eSIM_RSP-D.png)

{% hint style="info" %}
SIMs can only connect to one network at a time.

For information about supported modules, see [supported modules](modules-supporting-remote-sim-provisioning-rsp.md).
{% endhint %}
