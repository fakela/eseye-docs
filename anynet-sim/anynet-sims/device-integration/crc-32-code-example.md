...
{% hint style="info" %}
You can find this code example in [Apple's CRC-32 source](https://opensource.apple.com/source/xnu/xnu-1456.1.26/bsd/libkern/crc32.c). © Gary S. Brown.
{% endhint %}
...
{% hint style="info" %}
The `updcrc` logic must right-shift values by eight bits. The shift must be unsigned and bring in zeroes. On some hardware, byte-swap instructions can optimise the shift for polynomial `0xedb88320`.
{% endhint %}
