...
Some customers may choose to route only some, or no network traffic through [VPN](https://app.gitbook.com/s/hPiB0Z0YdVhl1D9teuS7/) tunnels. For example, they may not require a VPN, or may have some data for transferring to destinations other than their central system, such as partner systems.
...
{% hint style="info" %}
If you want to use ACL rules for this, Eseye must configure secure subnets for your devices. You must supply the configuration information for the rules, using the [AnyNet Subnet and Security Options Order Form (XLS, download)](https://app.gitbook.com/s/X0cODzoDlWNEI5nvG9sX/).
